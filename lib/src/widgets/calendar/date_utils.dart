...
class Utils {
  ...
  static String getTodayLabel(DateTime date) {
    String todayLabel;

    String weekday = DateFormat('EEEE').format(date);
    String numberday = DateFormat('d').format(date);
    String monthlabel = DateFormat('MMM').format(date);
    String yearlabel = DateFormat('y').format(date);

    todayLabel = weekday + " " + numberday + ", " + monthlabel;
  ...
  static String getMonthLabel(DateTime date) {
    ...
    String monthName = monthLabels[date.month - 1];

    return monthName;
  }

  static String getMonthLabelShort(DateTime date) {
